...
const ResultItem = React.forwardRef(
  (
    ...
    return (
      <div
        ref={ref}
        className={`relative z-10 flex cursor-pointer items-center justify-between bg-card px-4 py-3`}>
        {active && (
          <div
            id="kbar-result-item"
            className="absolute inset-0 !z-[-1] border-l-4 border-sidebar-primary bg-sidebar-accent"></div>
        )}
